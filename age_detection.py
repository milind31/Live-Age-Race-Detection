...
while True:
        ...
        for (x, y, w, h) in faces:
                ...
                obj = DeepFace.analyze(detected_face, actions=['age'], enforce_detection=False) #feed to model
                cv2.rectangle(img, (x, y), (x + w, y + h), (36,255,12), 1) #draw rectangle
                display_string = str(round(obj["age"]))
                cv2.putText(img, display_string, (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (36,255,12), 1, cv2.LINE_AA) #add text
